...
class RecommenderResponse
{
    ...
    const MESSAGE_TYPE_SUCCESS = ilGlobalTemplate::MESSAGE_TYPE_SUCCESS;
    const MESSAGE_TYPE_INFO = ilGlobalTemplate::MESSAGE_TYPE_INFO;
    const MESSAGE_TYPE_QUESTION = ilGlobalTemplate::MESSAGE_TYPE_QUESTION;
    const MESSAGE_TYPE_FAILURE = ilGlobalTemplate::MESSAGE_TYPE_FAILURE;
